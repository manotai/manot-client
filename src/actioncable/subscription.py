...
class Subscription:
    ...
    def create(self):
        ...
        print('Create subscription on server...')
    ...
    def remove(self):
        ...
        print('Remove subscription from server...')
    ...
    def received(self, data):
        ...
        if message_type == 'confirm_subscription':
            ...
            print('Message type unknown. ({})'.format(message_type))
